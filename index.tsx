...
export const Counter = () => {
  ...
  return (
    <div id="container" style={{ textAlign: 'center', fontSize: 28 }}>
      ...
      <button style={{ height: 40 }} onClick={handleIncrement}>
        +1
      </button>{' '}
      <button style={{ height: 40 }} onClick={handleStop}>
        stop
      </button>{' '}
      <button style={{ height: 40 }} onClick={handleDecrement}>
        -1
      </button>{' '}
      <button style={{ height: 40 }} onClick={handleStartDecrease}>
        start decrease
      </button>{' '}
    </div>
  );
